---
description: >-
  Assess work done inside Microsoft Excel through the EXAMIND plugin — with
  dynamic per-student data, auto-grading, and LMS sync. Currently in closed beta.
---
...
Behind the scenes, an Excel assessment is delivered as an [**Excel Workbook question**](../question-builder/question-types/excel-workbook.md) — the same question type, configured by EXAMIND and placed in an exam, quiz, or practice assessment for you during the beta.

{% hint style="info" %}
**Not what you're looking for?** If you want to *generate question content* with Excel-style formulas — for example, an exam multiple-choice question whose numbers are computed — that's the dynamic engine's [Excel Functions](../question-builder/dynamic-questions/dynamic-engine/excel.md), a different feature.
{% endhint %}
