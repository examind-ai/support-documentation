...
A [system that harnesses leading AI models](feedback-machines/overview.md) to auto-grade and provide detailed, rubric-aligned feedback on qualitative student work — essays, memos, case studies, presentations, EXAMIND Simluations and more — in two modes: **iterative draft feedback** and **bulk-grading-assist**.

## Where to start

<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Get Started</strong></td><td>Set up EXAMIND on its own or connected to your LMS.</td><td><a href="get-started/lms-integrated/README.md">get-started/lms-integrated/README.md</a></td></tr><tr><td><strong>Feedback Machines</strong></td><td>Auto-grade and give feedback on written work.</td><td><a href="feedback-machines/overview.md">feedback-machines/overview.md</a></td></tr><tr><td><strong>Our Approach</strong></td><td>Why EXAMIND assesses the way it does.</td><td><a href="our-approach/README.md">our-approach/README.md</a></td></tr></tbody></table>
